...
public class Main2 {
    public static void main(String[] args) {
        ArrayList<String> vlanguage = new ArrayList<>();
        vlanguage.add("BEGIN");
        vlanguage.add("INTEGER A, B, C, E, M, N, G, H, I, a, c");
        vlanguage.add("INPUT A, B, C");
        vlanguage.add("LET B = A */ M");
        vlanguage.add("LET G = a + c");
        vlanguage.add("temp = <s%**h - j / w +d +*$&;");
        vlanguage.add("M = A/B+C");
        vlanguage.add("N = G/H-I+a*B/c");
        vlanguage.add("WRITE M");
        vlanguage.add("WRITEE F;");
        vlanguage.add("END");

        for(String vlangString : vlanguage){
            ArrayList<String> vlang = new ArrayList<>();
            vlang.add(vlangString);
